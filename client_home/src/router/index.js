...
const routes = [
	...
	},
	{
		...
		// 电影信息列表路由
	{
		path: '/film_information/list',
		name: '/film_information_list',
		component: () => import('../views/film_information/list.vue')
	},
	
		// 电影信息详情路由
	{
		path: '/film_information/details',
		name: '/film_information_details',
		component: () => import('../views/film_information/details.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "电影推荐系统-home";
	document.title = title;
	document.logo = "电影推荐系统"
})
