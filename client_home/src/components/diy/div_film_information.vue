<template>
	<div class="diy_details_box diy_div_film_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/film_information/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/film_information/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var film_information_id = this.obj.film_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "film_information",
          source_field: "film_information_id",
          source_id: film_information_id
        }, (res) => {
